...
declare module 'mongoose' {
  ...
  class Schema<T = any> extends events.EventEmitter {
    ...
    post<T extends Document>(
      method: 'insertMany',
      fn: (this: Model<Document>, error: mongodb.MongoError, docs: T[], next: (err?: NativeError) => void) => void,
    ): this
    ...
    post<T extends Document>(method: string | RegExp, fn: (doc: T, next: (err?: NativeError) => void) => void): this
  ...
  class DocumentQuery<T, DocType extends Document, QueryHelpers = {}> extends mquery {
    ...
    find(criteria: any, callback?: (err: any, res: DocType[]) => void): DocumentQuery<DocType[], DocType> & QueryHelpers
    ...
    update(criteria: any, doc: any, callback?: (err: any, affectedRows: number) => void): Query<number> & QueryHelpers
    update(
      criteria: any,
      doc: any,
...
+    * https://mongoosejs.com/docs/api.html#mongoose_Mongoose-set
     ...
     */
    update(conditions: any, doc: any, callback?: (err: any, raw: any) => void): Query<any> & QueryHelpers
    update(
      conditions: any,
      doc: any,
    ...
    updateOne(conditions: any, doc: any, callback?: (err: any, raw: any) => void): Query<any> & QueryHelpers
    updateOne(
      conditions: any,
      doc: any,
      options: ModelUpdateOptions,
    ...
    updateMany(conditions: any, doc: any, callback?: (err: any, raw: any) => void): Query<any> & QueryHelpers
    updateMany(
      conditions: any,
      doc: any,
      options: ModelUpdateOptions,
